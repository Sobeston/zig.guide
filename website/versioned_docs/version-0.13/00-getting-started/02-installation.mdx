...
<Tabs
    ...
    1. [Download](https://ziglang.org/download/#release-0.13.0) a prebuilt version of Zig.
        ...
        Choose a build of Zig 0.13.0 for Linux that matches your CPU architecture. If you're unsure which architecture you're using, this can be found with:
    ...
    1. [Download](https://ziglang.org/download/#release-0.13.0) a prebuilt version of Zig.
        ...
        Choose a build of Zig 0.13.0 for Windows that matches your CPU architecture. Most Windows systems use `x86_64`, also known as `AMD64`. If you're unsure which architecture you're using, this can be found with:
